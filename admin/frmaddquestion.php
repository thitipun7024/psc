	...
	<form action="insertquestion.php" method="post" enctype="multipart/form-data">
		...
		<div class="container-fluid">
			<div class="row justify-content-center">
				<h1 class="text-center py-1 fw-bold">เพิ่มกระดานบอร์ด</h1>
				<div class="col-md-8 col-lg-7">
					<div class="card border-0 shadow">
						<div class="card-body">
                            ...
                            <div class="form-outline py-2">
								<input class="form-control" type="text" name="topic" placeholder="หัวข้อ" required>
							</div>
							...
							<div class="text-end py-3">
								<button class="btn btn-outline-success">เพิ่มกระดานบอร์ด</button>
							</div>
						</div>
					</div>
				</div>
